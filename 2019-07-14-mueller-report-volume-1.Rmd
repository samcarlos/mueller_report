...
![settle down and have another cup of coffee](/Users/sweiss/src/new_blogs/static/post/iws.jpg)
...
```{r freqplot, fig.width = 6,fig.height = 6, echo=FALSE, results='asis',fig.align='center', message = FALSE}
library(ggplot2)
...
```{r allnetwork, fig.width = 6,fig.height = 6, echo=FALSE, results='asis',fig.align='center'}
...
```{r russian_network, fig.width = 6,fig.height = 6, echo=FALSE, results='asis',fig.align='center'}
...
```{r slope_plot, fig.width = 6,fig.height = 10, echo=FALSE, results='asis',fig.align='center'}
...
#Trump Business
```{r business, fig.width = 6,fig.height = 6, echo=FALSE, results='asis',fig.align='center'}
...
#The Oppurtunists 
```{r oppurtunists, fig.width = 6,fig.height = 6, echo=FALSE, results='asis',fig.align='center'}
...
#The Professionals 
```{r profs, fig.width = 6,fig.height = 6, echo=FALSE, results='asis',fig.align='center' }
...
```{r officials, fig.width = 6,fig.height = 6, echo=FALSE, results='asis',fig.align='center' }
...
#All Together Graph 
```{r ts_plot, fig.width = 8,fig.height = 10, echo=FALSE, results='asis',fig.align='center'}
